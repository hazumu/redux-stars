...
/***/ function(module, exports, __webpack_require__) {
	...
	var _star = __webpack_require__(193);

	var _star2 = _interopRequireDefault(_star);

	var _star3 = __webpack_require__(194);
	...
	function mapDispatchToProps(dispatch) {
	  return {
	    handleMousemove: function handleMousemove(e) {
	      dispatch(_star4.default.mousemove(e));
	    },
	    handleUpdate: function handleUpdate() {
	      dispatch(_star4.default.update());
	    }
	  };
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_star2.default);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      var rows = this.props.starPositions.map(function (elm) {
	        ...
	        return _react2.default.createElement('img', { src: './img/star.svg', style: style, width: '20' });
	      });
